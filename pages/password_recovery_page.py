import allure
from web_locators.locators import ForgotPasswordLocators, LoginLocators
...
class PasswordRecoveryPage(BasePage):
    ...
    def set_email_for_reset_password(self, email):
        self.set_text_to_element(ForgotPasswordLocators.INPUT_EMAIL, email)
    ...
    def click_on_show_password_button(self):
        self.move_to_element_and_click(ForgotPasswordLocators.SHOW_PASSWORD_BUTTON)

    @allure.step('Найти кнопку Сохранить')
    def find_save_button(self):
       return self.wait_until_element_is_visible(ForgotPasswordLocators.SAVE_BUTTON)

    @allure.step('Найти активное поле Пароль')
    def find_input_active(self):
        return self.wait_until_element_is_visible(ForgotPasswordLocators.INPUT_ACTIVE)